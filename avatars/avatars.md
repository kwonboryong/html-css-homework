...
#### HTML 
- alt 속성과 aria-label 속성을 중복으로 제공하지 않아야 함. alt 속성으로 충분. => **피드백 반영**
- 프로필 1이라는 대체텍스트가 적절한지 고민해 보기 바람. => **피드백 반영**
...
#### CSS
- online, offline 클래스에 중복된 스타일이 제공되고 있음. 이를 효율적으로 구성하기 위한 고민이 보이지 않음. => **피드백 반영**
- order 속성 값은 2가 아닌 1을 제공하는 것을 추천함 => **피드백 반영**
